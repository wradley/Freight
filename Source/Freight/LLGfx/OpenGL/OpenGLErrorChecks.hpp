...
#define OGL_VERIFY_SHADER_SIGNATURE(sig, devicePtr) FR8_DBG_ASSERT(devicePtr->ownsShaderSignature(sig), "Shader Signature [" << sig.debugName << "] does not exist in device [" << devicePtr->getDebugName() << "]");
